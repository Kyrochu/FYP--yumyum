    ...
    <body>
        ...
        <div class="side-bar">
            ...
            <div class="menu">
                ...
                <div class="item"><a href="AdminPanel.phpid=<?php echo $id; ?>"><i class="fas fa-desktop"></i> Dashboard </a></div>
                ...
                <i class="fas fa-angle-right dropdown"> </i>
                    ...
                    <div class="sub-menu">
                        ...
                        <a href="SubUserAcc.phpid=<?php echo $id; ?>" class="sub-item"> User </a>
                        <a href="SubAdminAcc.phpid=<?php echo $id; ?>" class="sub-item"> Admin </a>
