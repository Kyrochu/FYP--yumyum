...
<head>
    ...
    <style>
        ...
        *{
        ...
        #creditcard form .inputBox input#state,
        #creditcard form .inputBox input#pcode
        {
            width: 49%;
            padding: 10px;
            border-radius: 10px;
...
<body>
    ...
    <div id="creditcard">
        <div class="container">
            ...
            <!-- for pull the id and total price -->
            ...
            <form action="" method="post" name="carddetail">
                <div class="inputBox">
                ...
                <script>
                    document.querySelector('.card-number-input').addEventListener('input', function() {
                        ...
                        if (cardNumber.startsWith('4')) {
                            icon.innerHTML = '<img src="img/visa.jpeg" alt="Visa">';
                        } 
                        else if (cardNumber.startsWith('5')) {
                            icon.innerHTML = '<img src="img/master.png" alt="Mastercard" style="height: 55px; width: 110px;">';
                        }
                    });
                </script>
                <script>
                ...
                <div class="inputBox">
                    <span>Card Name</span>
                    <input type="text" maxlength="30" class="card-holder-input" id="credit-card-holder-name" name="card_holder_name" pattern="^[a-zA-Z\s]+$" value="" >
                    <span id="error_message2" style="color: red;"></span>
                </div>
                <div class="inputBox">
                    <span>Email</span>
                    <input type="email" class="card-holder-input" placeholder="example@example.com" value="" id="email" name="email" required>
                    <span id="error_message2" style="color: red;"></span>
                </div>
                <div class="inputBox">
                    <span>Address</span>
                    <input type="email" class="card-holder-input" placeholder="NO 29, Jalan Klebang" value="" id="address" name="address" required>
                    <span id="error_message2" style="color: red;"></span>
                </div>
                <div class="inputBox">
                    <span>City</span>
                    <input type="email" class="card-holder-input" placeholder="Batu Berendam" value="" id="city" name="city" required>
                    <span id="error_message2" style="color: red;"></span>
                </div>
                <div class="inputBox">
                    <span>State &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;Post Code</span>
                    <input type="email" class="card-holder-input" placeholder="Melaka" value="" id="state" name="state" required>  
                    
                    <input type="email" class="card-holder-input" placeholder="75300" value="" id="pcode" name="pcode" required>
                    <span id="error_message2" style="color: red;"></span>
