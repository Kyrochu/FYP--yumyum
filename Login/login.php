    ...
    <body>
        ...
        <div class="form_page">
            ...
            <form id="reg" class="input_group" method="POST">
                ...
                <input type="password" class="input_place" name="in_user_password" placeholder="Password" required  title="Please enter a password with at least one capital letter and no any symbol">
